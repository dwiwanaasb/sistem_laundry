...
if (isset($_POST["cari"])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM pembayaran WHERE tanggal LIKE '%$keyword%'");
}
?>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="on"><a href="adminPembayaran.php"><i class="fa fa-money" aria-hidden="true"></i>List Pembayaran</a></li>
    ...
    <div class="container-search">
        <form method="post" action="">
            <input type="text" name="keyword" placeholder="Masukkan Tanggal Pembayaran..." autocomplete="off">
        ...
        <tbody>
            <?php foreach ($result as $row) : ?>
                <tr>
                    ...
                    <td class="aksi"><a href="updatePembayaran.php?id_order=<?php echo $row['id_order']; ?>"><button class="update"><i class="fas fa-pencil-alt"></i></button></a><a href="hapusPembayaran.php?id_order=<?php echo $row['id_order']; ?>"><button class="hapus"><i class="fas fa-trash"></i></button></a></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
